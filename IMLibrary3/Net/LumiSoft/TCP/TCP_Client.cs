...
{    
    ...
    public class TCP_Client : TCP_Session
    {
        ...
        void m_pTimer_IdleTimeout_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            if (this.IsConnected)
            {
                this.TcpStream.WriteLine(" ");
                //Console.WriteLine("sendouttime");
                //System.Windows.Forms.MessageBox.Show("sendouttime");
            }
        }
        ...
        public void Connect(string host, int port, bool ssl)
        {
            ...
            {
                return;// throw new ArgumentException("Argument 'host' value may not be null or empty.");
            }
            if (port < 1)
            {
            ...
            if (this.IsConnected)
            {
                m_pTimer_IdleTimeout.Enabled = true;//维持在线数据
                BeginReadCmd();
            }
        }
            ...
            internal bool Start(TCP_Client owner)
            {
                ...
                try{
                    ...
                    if(m_pRemoteEP.AddressFamily == AddressFamily.InterNetwork){
                        ...
                        m_pSocket.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.ReuseAddress, true);    
                    }   
        ...
        /// <summary>
        /// This  is called after TCP client has sucessfully connected.
        /// </summary>
        ...
        #region exEvents Implementation
        ...
        public delegate void PacketReceivedEventHandler(object sender, TcpSessionEventArgs e);
        /// <summary>
        /// 数据到达事件
        /// </summary>
        ...
        private void OnPacketReceived(string Data)
        {
            ...
            {
                this.PacketReceived(this, new TcpSessionEventArgs(Data));
            }
        }
